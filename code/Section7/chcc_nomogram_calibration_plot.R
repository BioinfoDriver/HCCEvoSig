...
pdf('chcc_cali.pdf')
plot(oneyear.cal, lwd=2, lty=1, pch=16, errbar.col='#D9D5D4', xlim=c(0.4, 1), ylim=c(0.2, 1), 
...
plot(threeyear.cal, lwd=2, lty=1, pch=16, errbar.col='#B0C767', xlim=c(0.4, 1), ylim=c(0.2, 1), 
     xlab='Nomogram-predicted Survival', ylab='Proportion of Patients Alive', legend=FALSE,
     col='#B0C767', subtitles=F, add=TRUE, par.corrected=list(col="#B0C767", lty=1, lwd=2, pch=17))

# plot(fiveyear.cal, lwd=2, lty=1, pch=16, errbar.col='#ECD1D2', xlim=c(0.4, 1), ylim=c(0.2, 1), 
# xlab='Nomogram-predicted Survival', ylab='Proportion of Patients Alive', legend=FALSE,
